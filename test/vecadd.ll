...
define weak hidden void @__assert_fail(i8* %0, i8* %1, i32 %2, i8* %3) #2 {
  ...
  %28 = call i64 @__ockl_fprintf_stderr_begin() #18
...
44:                                               ; preds = %37
  ...
  %49 = call i64 @__ockl_fprintf_append_string_n(i64 %45, i8* %46, i64 %48, i32 0) #18
...
65:                                               ; preds = %58
  ...
  %70 = call i64 @__ockl_fprintf_append_string_n(i64 %66, i8* %67, i64 %69, i32 0) #18
  store i64 %70, i64* %21, align 8
  %71 = load i64, i64* %21, align 8
  %72 = load i32, i32* %18, align 4
  %73 = zext i32 %72 to i64
  %74 = call i64 @__ockl_fprintf_append_args(i64 %71, i32 1, i64 %73, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i32 0) #18
...
90:                                               ; preds = %83
  ...
  %95 = call i64 @__ockl_fprintf_append_string_n(i64 %91, i8* %92, i64 %94, i32 0) #18
...
111:                                              ; preds = %104
  ...
  %116 = call i64 @__ockl_fprintf_append_string_n(i64 %112, i8* %113, i64 %115, i32 1) #18
  call void @llvm.trap()
  ret void
}
...
define protected amdgpu_kernel void @add(double addrspace(1)* %0, double addrspace(1)* %1, double addrspace(1)* %2, i32 %3) #4 {
  ...
  %27 = call i64 @__ockl_get_local_id(i32 0) #10
  %28 = call i64 @__ockl_get_local_size(i32 0) #10
  %29 = call i64 @__ockl_get_group_id(i32 0) #10
  %30 = mul i64 %28, %29
  %31 = add i64 %27, %30
...
define internal i64 @__ockl_fprintf_stderr_begin() #5 {
  %1 = tail call <2 x i64> @__ockl_hostcall_preview(i32 2, i64 33, i64 1, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0) #18
...
define internal <2 x i64> @__ockl_hostcall_preview(i32 %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8) local_unnamed_addr #5 {
  ...
  %15 = tail call <2 x i64> @__ockl_hostcall_internal(i8* %14, i32 %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8) #18
  ret <2 x i64> %15
}
...
define internal <2 x i64> @__ockl_hostcall_internal(i8* %0, i32 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8, i64 %9) local_unnamed_addr #7 {
  ...
  %31 = call fastcc i32 @0(i32 %30) #19
  ...
  %42 = call fastcc i64 @1(%0 addrspace(1)* %39, i32 %40, i32 %41) #19
  ...
  %50 = call fastcc %1 addrspace(1)* @2(%1 addrspace(1)* %47, i64 %49, i64 %45) #19
  ...
  %58 = call fastcc %2 addrspace(1)* @3(%2 addrspace(1)* %55, i64 %57, i64 %53) #19
  ...
  call fastcc void @4(%1 addrspace(1)* %59, %2 addrspace(1)* %60, i32 %61, i64 %62, i64 %63, i64 %64, i64 %65, i64 %66, i64 %67, i64 %68, i64 %69, i32 %70, i32 %71) #19
  ...
  call fastcc void @5(%0 addrspace(1)* %72, i64 %73, i32 %74, i32 %75) #19
  ...
  %81 = call fastcc <2 x i64> @6(%1 addrspace(1)* %77, %2 addrspace(1)* %78, i32 %79, i32 %80) #19
  ...
  call fastcc void @7(%0 addrspace(1)* %82, i64 %83, i32 %84, i32 %85) #19
...
define internal fastcc i32 @0(i32 %0) unnamed_addr #9 {
  %2 = tail call i32 asm sideeffect "; ockl readfirstlane hoisting hack $0", "=v,0"(i32 %0) #18, !srcloc !24
  ret i32 %2
}
...
define internal fastcc void @4(%1 addrspace(1)* nocapture writeonly %0, %2 addrspace(1)* nocapture writeonly %1, i32 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8, i64 %9, i64 %10, i32 %11, i32 %12) unnamed_addr #12 {
  %14 = tail call i64 @llvm.read_register.i64(metadata !25) #19
...
22:                                               ; preds = %17, %6
  ...
  tail call void @__ockl_hsa_signal_add(i64 %24, i64 1, i32 3) #18
  br label %25
...
define internal i64 @__ockl_fprintf_append_args(i64 %0, i32 %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8, i32 %9) #5 {
  ...
  %17 = or i64 %14, %16
  %18 = tail call <2 x i64> @__ockl_hostcall_preview(i32 2, i64 %17, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8) #18
...
9:                                                ; preds = %4
  %10 = and i64 %7, -225
  %11 = or i64 %10, 32
  %12 = tail call <2 x i64> @__ockl_hostcall_preview(i32 2, i64 %11, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0) #18
  br label %455
...
444:                                              ; preds = %431, %393, %391
  ...
  %449 = and i64 %29, -225
  %450 = or i64 %449, %448
  %451 = tail call <2 x i64> @__ockl_hostcall_preview(i32 2, i64 %450, i64 %89, i64 %149, i64 %209, i64 %269, i64 %329, i64 %389, i64 %445) #18
  %452 = sub i64 %18, %27
...
define internal i64 @__ockl_get_local_size(i32 %0) #17 {
...
3:                                                ; preds = %1
  ...
  %7 = load i16, i16 addrspace(4)* %6, align 4, !range !34, !invariant.load !35
  %8 = getelementptr inbounds i8, i8 addrspace(4)* %2, i64 12
  %9 = bitcast i8 addrspace(4)* %8 to i32 addrspace(4)*
  %10 = load i32, i32 addrspace(4)* %9, align 4, !tbaa !36
  br label %27
...
11:                                               ; preds = %1
  ...
  %15 = load i16, i16 addrspace(4)* %14, align 2, !range !34, !invariant.load !35
  %16 = getelementptr inbounds i8, i8 addrspace(4)* %2, i64 16
  %17 = bitcast i8 addrspace(4)* %16 to i32 addrspace(4)*
  %18 = load i32, i32 addrspace(4)* %17, align 8, !tbaa !39
  br label %27
...
19:                                               ; preds = %1
  ...
  %23 = load i16, i16 addrspace(4)* %22, align 4, !range !34, !invariant.load !35
  %24 = getelementptr inbounds i8, i8 addrspace(4)* %2, i64 20
  %25 = bitcast i8 addrspace(4)* %24 to i32 addrspace(4)*
  %26 = load i32, i32 addrspace(4)* %25, align 4, !tbaa !40
  br label %27
...
; Function Attrs: convergent mustprogress nofree norecurse nosync nounwind readnone willreturn
define internal i64 @__ockl_get_local_id(i32 %0) #17 {
...
2:                                                ; preds = %1
  %3 = tail call i32 @llvm.amdgcn.workitem.id.x(), !range !41
  br label %8

4:                                                ; preds = %1
  %5 = tail call i32 @llvm.amdgcn.workitem.id.y(), !range !41
  br label %8

6:                                                ; preds = %1
  %7 = tail call i32 @llvm.amdgcn.workitem.id.z(), !range !41
  br label %8
...
; Function Attrs: convergent mustprogress nofree norecurse nosync nounwind readnone willreturn
define internal i64 @__ockl_get_group_id(i32 %0) #17 {
  switch i32 %0, label %8 [
    i32 0, label %2
    i32 1, label %4
    i32 2, label %6
...
attributes #17 = { convergent mustprogress nofree norecurse nosync nounwind readnone willreturn "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" }
...
!35 = !{}
!36 = !{!37, !17, i64 12}
!37 = !{!"hsa_kernel_dispatch_packet_s", !38, i64 0, !38, i64 2, !38, i64 4, !38, i64 6, !38, i64 8, !38, i64 10, !17, i64 12, !17, i64 16, !17, i64 20, !17, i64 24, !17, i64 28, !11, i64 32, !15, i64 40, !11, i64 48, !20, i64 56}
!38 = !{!"short", !12, i64 0}
!39 = !{!37, !17, i64 16}
!40 = !{!37, !17, i64 20}
!41 = !{i32 0, i32 1024}
